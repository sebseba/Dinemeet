...
class _$GroupImpl implements _Group {
  const _$GroupImpl({
    ...
    this.mode = '1v1',
    final List<String> participantUids = const [],
    this.status = 'pending',
    this.reservationRef,
    this.createdAt,
    this.updatedAt,
  ...
  @override
  String toString() {
    return 'Group(groupId: $groupId, mode: $mode, participantUids: $participantUids, status: $status, reservationRef: $reservationRef, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
